...
SELECT *
FROM t_employees e
WHERE e.deptno=(SELECT deptno FROM t_dept WHERE dname='销售部');
...
WHERE e.deptno=d.deptno AND job=(SELECT job FROM t_employees WHERE ename='曹操');
